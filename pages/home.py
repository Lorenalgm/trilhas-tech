...
def render():
    """Render home page with project explanation"""
    render_header(
    ...
    - **Visualização de Trilha**: Veja todos os níveis de carreira em uma visão clara
    - **Detalhes por Cargo**: Competências técnicas e não técnicas com evidências e materiais recomendados
    - **Comparação Visual**: Gráfico de radar para comparar habilidades entre cargos
    - **Destaque de Gaps**: Identifique novas competências e áreas para aprofundar
    ...
    **Feito para o Pupunha Code Meetup** — fork e customize as trilhas via YAML.
    """)
